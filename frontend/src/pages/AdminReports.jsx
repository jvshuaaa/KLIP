        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="md:col-span-1">
            <div className="bg-white rounded-lg shadow">
              <nav className="py-2">
                <a href="/admin/dashboard" className="block px-4 py-3 text-gray-700 hover:bg-gray-50">
                  Dashboard
                </a>
                <a href="/admin/reports" className="block px-4 py-3 text-blue-600 bg-blue-50 font-medium border-l-4 border-blue-600">
                  Laporan
                </a>
              </nav>
            </div>
